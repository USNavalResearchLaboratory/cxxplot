...
public:
  ...
  */
  ...
  void setScaleRatio( QCPAxis *otherAxis, double ratio=1.0); // Patched: removed const
  ...
  //Patch begin
  const double &getScaleRatio() const { return scaleRatio; }
  QCPAxis *getScaleRatioOtherAxis() const { return scaleRatioOtherAxis; }
  //Patch end
...
protected:
  ...
  QCPAxis *scaleRatioOtherAxis = nullptr;
...
// Patch begin
template <class DataType>
void QCPDataContainer<DataType>::append(const DataType &data)
{
    mData.append(data);
}
//Patch end
...
public:
  ...
  */
  ...
  //patch begin
  void appendData(double key, double value);
  //patch end
